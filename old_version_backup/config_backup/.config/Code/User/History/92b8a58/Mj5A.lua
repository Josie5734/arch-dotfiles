...
function draw_rules()
    ...
    for i=1,4 do rule_boxes(x,y,8) x+=24 end 
    ...
    for i=1,4 do rule_boxes(x,y,4) x+=24 end
...
--draw the boxes for the rules, n is the number write above the first box in the row
