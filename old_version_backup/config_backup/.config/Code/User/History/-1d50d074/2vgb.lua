...
function rules()
	...
	elseif ct[ci] == 0 then --rules 3,2,1,0
		...
		if ct[ci+1] == 1 and ct[ci+2] == 1 then nt[ni] = 1 --rule 3 (0,1,1) = 1
		elseif ct[ci+1] == 1 and ct[ci+2] == 0 then nt[ni] = 0 --rule 2 (0,1,0) = 1
		elseif ct[ci+1] == 0 and ct[ci+2] == 1 then nt[ni] = 1 --rule 1 (0,0,1) = 1
		elseif ct[ci+1] == 0 and ct[ci+2] == 0 then nt[ni] = 0 --rule 0 (0,0,0) = 0
		end
