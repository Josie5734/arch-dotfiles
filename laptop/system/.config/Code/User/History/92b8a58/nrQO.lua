...
function draw_rules()
    ...
    local n = 8
    for i=1,4 do rule_boxes(x,y,n) x+=24 n -= 1 end 
...
--draw the boxes for the rules, n is the number write above box
function rule_boxes(x,y,n)
    ...
    if n == 7 or n == 6 or n == 3 or n == 2 then
        rectfill(x+8,y+1,x+11,14)
    end
