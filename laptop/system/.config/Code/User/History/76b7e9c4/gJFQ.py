    ...
    match option:
        ...
        case "3": # remove an entry
            ...
            if key == "q": # if q for quit
                exec("{}()".format(table)) # reload menu without doing anything
        ...
        case "5": # filter
            ...
            exec("{}(filter_recs)".format(table)) # dynamically reload menu passing in filtered data, assuming table is the same as the menu function name
