...
### current objective:
    ...
    # add in rest of menus 
        ...
        # potentially make a quick sort for the equipment file since that will be the longest
...
def table_output(data_table,spacing,headers): # default output for the menu
...
def employees(records = None): 
    ...
    print("employees \n")
    # print data table
    table_output(records,spacing,headers) 
