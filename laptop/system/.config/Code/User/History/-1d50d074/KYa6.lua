...
--just done: finished the drawing of the selex system
...
function _draw()
	...
	draw_selex(((selexcg*5)+(selexcg*1)),10) --top row selex
	draw_selex(selexng*5+selexng*1,100) --bottom row selex
